    ...
    return (
        <div className="h-screen flex items-center justify-center">
            <div className="login-area flex flex-col w-[25%] gap-10">
                ...
                <div className="login-boxes relative">
                    ...
                    {loginError && (
                        <div className="absolute left-full top-1/2 -translate-y-1/2 ml-3 whitespace-nowrap rounded-md bg-red-500 px-3 py-5 text-sm text-white shadow-md">
